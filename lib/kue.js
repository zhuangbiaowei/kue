...
Queue.prototype.create = Queue.prototype.createJob = function(type, data, parent_id) {
    return new Job(type, data, parent_id);
};

Queue.prototype.remove = Queue.prototype.removeJob = function(id) {
...
Queue.prototype.promote = function(ms) {
    ...
    setInterval(function() {
        client.sort('q:jobs:delayed', 'by', 'q:job:*->delay', 'get', '#', 'get', 'q:job:*->delay', 'get', 'q:job:*->created_at', 'limit', 0, limit, function(err, jobs) {
...
Queue.prototype.process = function(type, phase, n, fn) {
    var self = this;

    if ('function' == typeof phase) {
        fn = phase;
        n = 1;
        phase = 'start';
    }
    if ('number' == typeof phase) {
        n = phase;
        fn = n;
        phase = 'start';
    }
